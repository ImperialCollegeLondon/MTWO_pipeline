...
if __name__ == "__main__":
    ...
    # --- 1. 加载配对训练数据 ---
    paired_data_path = r"E:\Raine\OneDrive - Imperial College London\IC\70007 Individual Project\MTWO_pipeline\mapping\paired_training_data\paired_training_data.pkl"
    ...
    for method in alignment_methods:
        ...
        try:
            ...
            # 保存模型
            model_dir = rf"E:\Raine\OneDrive - Imperial College London\IC\70007 Individual Project\MTWO_pipeline\mapping\results\LSTM\lstm_mapping_models_{method}"
